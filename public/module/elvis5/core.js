...
export default class elvis5 {
    ...
    constructor(param) {
        ...
        if (param.event) {
            ...
            if (param.event.onKeyUp) {
                window.addEventListener('keyup', param.event.onKeyUp.bind(THAT), false);
            }
    ...
    startRender() {
        ...
        if (this.onUpdateCallback) {
            ...
            let _onUpDate = this.onUpdateCallback;
            ...
            ((function () {
                let update = function () {
                    ...
                    let elpasedTime = THAT.clock.getElapsedTime();
                    // console.log(delta)
    ...
    updateAll(param) {
        ...
        if (param.resize !== undefined) {
            let resize = param.resize;
            if ('OrthographicCamera' == this.camera.type) {

                console.log('resize ortho');
                this.camera.left = -  this.camera.ratio * resize.width / 2;
                this.camera.right = this.camera.ratio * resize.width / 2;
                this.camera.top = resize.height / 2;
                this.camera.bottom = - resize.height / 2;
            }
            else {
